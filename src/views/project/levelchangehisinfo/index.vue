<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="levelchangehisinfoList" border>
...
<script>
  import { getLevelChangehisInfo,exportHistory} from "@/api/project/info";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        getLevelChangehisInfo().then(response => {
          this.levelchangehisinfoList = response.rows;
