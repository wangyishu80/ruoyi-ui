<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataList" highlight-current-row size="big" style="width: 100%;" border>
      ...
      <el-table-column label="收入合计(/元)" align="center" prop="empTotalSalary"  width="300px"/>
...
<script>
  import {  exportBudgetIncomeData,selectPerIncomeBudget } from "@/api/project/budgetperincome";
  export default {
    ...
    methods: {
      ...
      getList(item_id) {
        this.loading = true;
        selectPerIncomeBudget(item_id).then(response => {
      ...
      handleBudgetExport() {
        ...
        this.$confirm('是否确认导出所有数据项?', "警告", {
          ...
          return exportBudgetIncomeData(item_id);
        }).then(response => {
